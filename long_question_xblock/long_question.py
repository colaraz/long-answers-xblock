...
from long_question_xblock.constants import ITEM_TYPE
from long_question_xblock.showanswer import ShowAnswerXBlockMixin

from long_question_xblock.utils import (
    utcnow,
...
class LongQuestionXBlock(StudioEditableXBlockMixin, ShowAnswerXBlockMixin, XBlock):
    """
    ...
    def add_xml_to_node(self, node):
        ...
        """
        super(LongQuestionXBlock, self).add_xml_to_node(node)
    ...
    def student_view(self, context=None):
        ...
        """
        The primary view of the LongQuestionXBlock, shown to students
        ...
        fragment.add_content(
            render_template(
                'templates/long_question_xblock/show.html',
                context
            )
        )
        fragment.add_css(_resource("static/css/long_question_xblock.css"))
        fragment.add_javascript(_resource("static/js/src/long_question_xblock.js"))
        ...
        fragment.initialize_js('LongQuestionXBlock', self.student_state())
        return fragment
    ...
    def studio_view(self, context=None):  # pylint: disable=useless-super-delegation
        ...
        return super(LongQuestionXBlock, self).studio_view(context)
